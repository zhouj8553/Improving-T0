...
from tasks.p3.p3 import T0_TEST_TASK_NAME
...
def add_model_config_args(parser):
    ...
    group.add_argument('--t5-model', action='store_true', help='use t5-model')
...
def add_training_args(parser):
    ...
    group.add_argument('--no-deepspeed-save', action='store_true', help='Not use deepspeed when saving checkpoint')
    # FIXME: use args.mode
...
def add_evaluation_args(parser):
    ...
    group.add_argument('--eval_tag', type=str, default="-1")
    return parser
...
def add_data_args(parser):
    ...
    ### T0-specific
    group.add_argument('--multi-src-seq-length', type=int, default=None)
    group.add_argument('--multi-tgt-seq-length', type=int, default=None)
    group.add_argument('--multi-cache-dir', type=str, default=None)
    group.add_argument('--multi-task-set', type=str, default=None, choices=["t0", "t0+", "t0++", "debug"])
    group.add_argument('--reweight', type=bool, default=False)
    group.add_argument('--packing', action='store_true')
    group.add_argument('--t0_format', type=str, default="lm_format", choices=["lm_format", "denoise_format"])
    group.add_argument('--use_adafactor', action='store_true')
    group.add_argument('--eval-set', type=str, default='validation', choices=["train","validation", "test"])
    
    group.add_argument('--k_fold',type=int,default=-1)
    group.add_argument('--fold_id',type=int,default=-1)
    group.add_argument('--max_train_num_per_dataset',type=int,default=500000)
    group.add_argument('--max_valid_num_per_dataset',type=int,default=1000)
    group.add_argument('--debug',action="store_true")
    group.add_argument('--test-ckpt',type=str,default=None)
    group.add_argument('--t0-prepared-task-names',type=str,nargs='+', default=None,help="The data path to all prepared training files")
    group.add_argument('--t0-upsample-task-names',type=str,nargs='+', default=None,help="The data to be upsampled")
    group.add_argument('--t0-upsample-times',type=int,nargs='+',default=None,help="Upsample the t0-upsample-task-names for x times")
    return parser
...
def add_glm_args(parser):
    ...
    group.add_argument('--prefix-lm', action='store_true', help='Prefix LM in T5 paper')
    ...
    group.add_argument('--bert-mask-ratio', type=float, default=0.15)
...
def get_args(arg_list=None):
    ...
    if not args.tokenizer_type.startswith("hf_"):
